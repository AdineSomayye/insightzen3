...
#
# The default database uses PostgreSQL and reads its connection details
# from environment variables set in the docker-compose file. When
# running outside of Docker without a database container, you can set
# these variables accordingly or adjust the ENGINE to use SQLite.
DATABASES = {
    'default': {
